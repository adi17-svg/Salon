    ...
    >
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-amber-800 max-w-2xl mx-auto text-xl font-medium font-[Dancin_Script]">
              ...
              <div className="p-6">
                <div className="flex flex-wrap gap-2 mb-3">
                  {service.tags.map((tag, index) => (
                    <span
                      key={index}
                      className="bg-amber-50 text-amber-700 px-3 py-1 rounded-full text-sm font-medium border border-amber-200 hover:bg-amber-100 transition-colors"
                    >
                      {tag}
                    </span>
                  ))}
